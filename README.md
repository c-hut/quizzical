...
- [CSS Gradient](https://cssgradient.io) was used to create colour gradients and to source different shades of red.

- [CSS Tricks](https://css-tricks.com) was used for the following two purposes:

    - [Flexbox refresher](https://css-tricks.com/snippets/css/a-guide-to-flexbox/#aa-background).
    - [Positioning refresher](https://css-tricks.com/absolute-relative-fixed-positioining-how-do-they-differ).
